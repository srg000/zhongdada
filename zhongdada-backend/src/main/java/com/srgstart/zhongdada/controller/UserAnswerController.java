...
import com.srgstart.zhongdada.annotation.AuthCheck;
import com.srgstart.zhongdada.common.BaseResponse;
import com.srgstart.zhongdada.common.DeleteRequest;
...
import com.srgstart.zhongdada.model.dto.userAnswer.UserAnswerAddRequest;
import com.srgstart.zhongdada.model.dto.userAnswer.UserAnswerEditRequest;
import com.srgstart.zhongdada.model.dto.userAnswer.UserAnswerQueryRequest;
import com.srgstart.zhongdada.model.dto.userAnswer.UserAnswerUpdateRequest;
...
import com.srgstart.zhongdada.model.enums.ReviewStatusEnum;
import com.srgstart.zhongdada.model.vo.UserAnswerVO;
import com.srgstart.zhongdada.scoring.ScoringStrategyExecutor;
import com.srgstart.zhongdada.service.AppService;
import com.srgstart.zhongdada.service.UserAnswerService;
...
public class UserAnswerController {
    ...
    public BaseResponse<Long> addUserAnswer(@RequestBody UserAnswerAddRequest userAnswerAddRequest, HttpServletRequest request) {
        ...
        // 写入数据库
        // 这里需要捕获异常，防止由于时间戳造成的id相同 或者 存在恶意使用相同id请求的情况
        try {
    ...
    public BaseResponse<Boolean> updateUserAnswer(@RequestBody UserAnswerUpdateRequest userAnswerUpdateRequest) {
        ...
        List<String> voChoices = userAnswerUpdateRequest.getChoices();
    ...
    public BaseResponse<Boolean> editUserAnswer(@RequestBody UserAnswerEditRequest userAnswerEditRequest, HttpServletRequest request) {
        ...
        List<String> voChoices = userAnswerEditRequest.getChoices();
        userAnswer.setChoices(JSONUtil.toJsonStr(voChoices));
        // 数据校验
        userAnswerService.validUserAnswer(userAnswer, false);
        User loginUser = userService.getLoginUser(request);
     ...
     * @return
     */
    @GetMapping("/generate/userAnswerId")
