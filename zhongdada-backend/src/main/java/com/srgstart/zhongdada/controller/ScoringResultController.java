...
import com.srgstart.zhongdada.model.dto.scoringResult.ScoringResultAddRequest;
import com.srgstart.zhongdada.model.dto.scoringResult.ScoringResultEditRequest;
import com.srgstart.zhongdada.model.dto.scoringResult.ScoringResultQueryRequest;
import com.srgstart.zhongdada.model.dto.scoringResult.ScoringResultUpdateRequest;
import com.srgstart.zhongdada.model.entity.ScoringResult;
import com.srgstart.zhongdada.model.entity.User;
import com.srgstart.zhongdada.model.vo.ScoringResultVO;
import com.srgstart.zhongdada.service.ScoringResultService;
...
public class ScoringResultController {
    ...
    public BaseResponse<Long> addScoringResult(@RequestBody ScoringResultAddRequest scoringResultAddRequest, HttpServletRequest request) {
        ...
        List<String> voResultProp = scoringResultAddRequest.getResultProp();
    ...
    public BaseResponse<Boolean> updateScoringResult(@RequestBody ScoringResultUpdateRequest scoringResultUpdateRequest) {
        ...
        List<String> voResultProp = scoringResultUpdateRequest.getResultProp();
        scoringResult.setResultProp(JSONUtil.toJsonStr(voResultProp));
        // 数据校验
    ...
    public BaseResponse<Boolean> editScoringResult(@RequestBody ScoringResultEditRequest scoringResultEditRequest, HttpServletRequest request) {
        ...
        List<String> voResultProp = scoringResultEditRequest.getResultProp();
        scoringResult.setResultProp(JSONUtil.toJsonStr(voResultProp));
        // 数据校验
        scoringResultService.validScoringResult(scoringResult, false);
        User loginUser = userService.getLoginUser(request);
