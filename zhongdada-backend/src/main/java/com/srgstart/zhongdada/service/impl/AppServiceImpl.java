...
import com.srgstart.zhongdada.mapper.AppMapper;
...
import com.srgstart.zhongdada.model.enums.AppScoringStrategyEnum;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
     ...
     *
     * @param app
     * @param add   true：表示对创建数据校验，false：表示对修改数据校验
     */
    @Override
